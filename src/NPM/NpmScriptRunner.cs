...
namespace AspNetCoreWebpack.NPM
{
    class NpmScriptRunner
    {
        ...
        public NpmScriptRunner(string workingDirectory, string scriptName, string arguments, IDictionary<string, string> envVars)
        {
            ...
            nodeProcess = LaunchNodeProcess(processStartInfo);
            StdOut = new EventedStreamReader(nodeProcess.StandardOutput);
            StdErr = new EventedStreamReader(nodeProcess.StandardError);
        }
